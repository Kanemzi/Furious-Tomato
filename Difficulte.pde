...
float DIFF_delais_patterns;
int DIFF_niveau_patterns;

float DIFF_delais_couteaux;
float DIFF_vitesse_couteaux;
boolean DIFF_couteaux_derives;
boolean DIFF_couteau_pendant_pattern;

float DIFF_delais_sel;
float DIFF_surface_sel;
float DIFF_quantite_sel;

float DIFF_cout_endurence_impulsion;
